...
SSO_URL = "https://login.cdpworkshops.cloudera.com/auth/realms/se-workshop-1/protocol/saml/clients/cdp-sso"  # URL to your ML Workspace
ML_WORKSPACE = "backup-llm-hol" # Name of the ML workspace
